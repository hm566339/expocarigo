// src/navigation/owner/stacks/CarOwnerStack.tsx
...
import DownloadDocument from "../../../screens/car-owner/DownloadDocumant";
...
import VehicleDetailScreen from "@/src/screens/owner/VehicleDetailScreen";
import PickLocationScreen from "../../../screens/owner/PickLocationScreen";

const Stack = createNativeStackNavigator();

export const CarOwnerStack: React.FC = () => {
  return (
    <Stack.Navigator
      screenOptions={{
    ...
    >
      <Stack.Screen
        ...
        options={{ title: "Car Owners" }}
      />

      <Stack.Screen
        name="CreateCarOwner"
        component={CreateCarOwnerScreen}
      ...
      <Stack.Screen
        name="RatingAndTrips"
        component={RatingAndTripsScreen}
        options={{ title: "Rating & Trips" }}
      />
