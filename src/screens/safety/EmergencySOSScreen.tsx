...
//     Alert.alert("Deactivate SOS", "Are you safe now? This will stop location sharing with emergency services.", [
...
//           <Text style={styles.activeSubtext}>Emergency services and your contacts have been notified</Text>
...
//           In case of an emergency during your trip, press and hold the SOS button below.
//         </Text>

//         <View style={styles.featureList}>
//           <FeatureItem text="Alerts emergency services" />
//           <FeatureItem text="Notifies your emergency contacts" />
//           <FeatureItem text="Shares your live location" />
//           <FeatureItem text="Alerts CARIGO support team" />
//         </View>
//       </View>
