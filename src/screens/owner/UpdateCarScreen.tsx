...
//     const { vehicle } = route.params   // 👈 vehicle data
...
//         vehicle.vehicleVideo || null
//     )

//     /* ---------- EDITABLE STATES ---------- */
//     const [color, setColor] = useState(vehicle.color || "")
//     const [ratePerDay, setRatePerDay] = useState(
//         vehicle.ratePerDay ? String(vehicle.ratePerDay) : ""
//     )
//     const [ratePerHour, setRatePerHour] = useState(
//         vehicle.ratePerHour ? String(vehicle.ratePerHour) : ""
//     )
...
//             await VehicleService.updateVehicle(vehicle.id.toString(), {
//                 color,
...
//                 <Input label="Vehicle Number" value={vehicle.vehicleNumber} editable={false} />
//                 <Input label="Manufacturer" value={vehicle.manufacturer} editable={false} />
//                 <Input label="Model" value={vehicle.model} editable={false} />
//                 <Input
//                     label="Year"
